...
with st.expander("Вот так выглядит процесс создания нейронной сети"):
    st.write("В процессе создания проводится сбор базы данных из текстов. Разбиение на обучающую и тестовую выборки. "
             "Создание словаря частотности (он указывает насколько часто в тексте встречается то или иное слово)."
             "Калибровка параметров нейронной сети и ее проверка на тестовой выборке.")
    st.image(image_path)
